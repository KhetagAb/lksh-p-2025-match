...
class RegisterPlayerInSpotrSection(ABC):
    @abstractmethod
    async def register_player_in_sport_section(
...
class CreateTournament(ABC):
    ...
    async def create_tournament(
        self,
        tournament_interval: TournamentInterval,
        sport_name: SportSectionName,
    ) -> None:
        raise NotImplementedError
...
class GetListTournament(ABC):
    @abstractmethod
    async def get_list_tournament(
        self, sport_name: SportSectionName
    ) -> list[Tournament]:
        raise NotImplementedError
...
class RegisterTeamInTournament(ABC):
    ...
    async def register_team_in_tournament(
        self, tournament: Tournament, team_id: TeamId
    ) -> None:
        raise NotImplementedError
