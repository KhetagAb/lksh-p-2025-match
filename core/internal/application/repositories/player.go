...
func (p *Players) GetPlayerByID(ctx context.Context, id int64) (*domain2.Player, error) {
	var tgID int64
	var name string
	var username string
	...
	return &domain2.Player{ID: id, Name: name, TgUsername: username, TgID: tgID}, nil
}

func (p *Players) GetPlayerByTgID(ctx context.Context, tgID int64) (*domain2.Player, error) {
	var id int64
	var name string
	var username string
...
func (p *Players) GetPlayerByTgUsername(ctx context.Context, username string) (*domain2.Player, error) {
	var id int64
	var name string
	var tgID int64
