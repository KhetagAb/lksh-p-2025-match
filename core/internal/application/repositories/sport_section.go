...
func (s *SportSections) GetSportSectionByID(
	...
	return &domain2.SportSection{ID: id, EnName: enName, RuName: ruName}, nil
}
...
func (s *SportSections) GetSportsList(
	...
	sections := make([]domain2.SportSection, 0)

	for rows.Next() {
		var sec domain2.SportSection
